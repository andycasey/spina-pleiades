...
model = load_stan_model("lines_with_cluster_abundances_noprior.stan")
...
fig.tight_layout()
fig.savefig("lines_with_cluster_abundances_noprior_trace.pdf", dpi=300)
fig.savefig("lines_with_cluster_abundances_noprior_trace.png", dpi=300)
...
for i in range(S):
    ...
    ax.errorbar(x[ok], (y.T[i] - offset)[ok], 
        yerr=total_yerr[ok], fmt=None, ecolor="k")
...
fig.savefig("lines_with_cluster_abundances_noprior_fits.pdf", dpi=300)
fig.savefig("lines_with_cluster_abundances_noprior_fits.png", dpi=300)
